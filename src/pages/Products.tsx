          ...
          <div className={viewMode === 'grid' 
            ...
            {paginatedProducts.map((product) => (
              <Card key={product.id} className={`hover:shadow-lg transition-shadow border border-gray-200 bg-white hover:border-orange-300 ${
                ...
                <CardContent className={`p-3 ${viewMode === 'list' ? 'flex flex-row w-full' : ''}`}>
                  <div className={`relative ${viewMode === 'list' ? 'w-32 flex-shrink-0 mr-4' : 'mb-3'}`}>
                    <img 
                      src={product.image} 
                      alt={product.name}
                  ...
                  <div className={`${viewMode === 'list' ? 'flex-1 flex flex-col justify-between' : ''}`}>
                    ...
                    <div className={`flex items-center ${
                      ...
                      <div className="flex flex-col">
                        <span className={`font-bold text-gray-900 ${viewMode === 'list' ? 'text-base' : 'text-sm'}`}>
                      ...
                      <Button 
                        ...
                        className="bg-orange-600 hover:bg-orange-700 disabled:bg-gray-400 text-xs px-2 py-1"
                      >
