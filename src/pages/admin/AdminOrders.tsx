...
import { ShoppingCart, Eye, Package, DollarSign, Clock, CheckCircle, Search } from 'lucide-react';
  ...
  return (
    <div className="space-y-4 sm:space-y-6 animate-fade-in">
      ...
      <Card className="shadow-lg">
        <CardHeader>
          <CardTitle className="text-xl sm:text-2xl">All Orders ({totalOrders})</CardTitle>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <div className="mt-2 space-y-2">
                      <p><span className="font-medium">Name:</span> {selectedOrder.profiles?.full_name || 'Unknown'}</p>
                      <p><span className="font-medium">Email:</span> {selectedOrder.profiles?.email || 'No email'}</p>
                      <p><span className="font-medium">Phone:</span> {selectedOrder.profiles?.phone || 'No phone'}</p>
                    </div>
                  </div>
